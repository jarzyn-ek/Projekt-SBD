...
class ProjectsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'expected_profit' => ['type' => 'decimal', 'length' => 10, 'precision' => 0, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'start_date' => '2020-01-07 21:01:12',
                'end_date' => '2020-01-07 21:01:12',
                'expected_profit' => 1.5,
            ],
        ];
        parent::init();
